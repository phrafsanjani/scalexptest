...
The computed rejection regions are for the test statistic $2(-\sum_{i}^{n}t(X_i))\theta_0^r$,
...
but for testing $H_0: \theta = \sqrt{3}$ vs $H_1: \theta > \sqrt{3}$ with $n = 15$, $\alpha = 0.05$, and $\theta_1 = 2$:
...
```{r}
two_sided_rr(5, -1, 500, -1, 0.05, a = 900)
two_sided_beta(5, 5.75, -1, 500, -1, 0.05, a = 900)
```
...
```{r}
#interval_null_rr(2, , -2, 25, -1, 0.01)
#interval_null_beta(1, , sqrt(2), -2, 25, -1, 0.01)
interval_null_rr(4.9, 5.1, -1, 500, -1, 0.05, a = 900)
interval_null_beta(4.9, 5.1, 5.5, -1, 500, -1, 0.05, a = 900)
```